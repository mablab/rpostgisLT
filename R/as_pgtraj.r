...
as_pgtraj <- function(conn, schema = "pgtraj", relocation_data, 
        pgtrajs, animals, bursts = NA, relocations, timestamp = NA, rid) {
    # Initial tests ------------------------------------------------------------
...
#    sql_temp <- paste0("CREATE TABLE relocs_temp AS
#                SELECT 
#                    ",rid," AS r_id,
#                    ",relocations,"::geometry AS relocation,
#                    ",timestamp,"::timestamptz AS date,
#                    ",bursts," AS b_name,
#                    ",animals," AS a_name,
#                    ",pgtrajs," AS p_name
